...
### Backend Developer • Node.js • TypeScript • NestJS • Microservices
...
Backend developer focused on building **scalable APIs** and **microservices** with Node.js and TypeScript. 
...
![Java](https://img.shields.io/badge/java-%23316192.svg?style=for-the-badge&logo=openjdk&logoColor=white)
![Spring Boot](https://img.shields.io/badge/Spring_Boot-%234ea94b.svg?style=for-the-badge&logo=Spring&logoColor=white)
...
- 📚 Preparing for AWS Cloud Practitioner Certification (Feb 2026)
...
I'm currently **open to backend developer positions** in companies that value:

- Clean code and scalable architecture
- Collaborative code reviews and continuous learning
- Modern backend technologies (Node.js, TypeScript, microservices)
- International/remote work with diverse teams

**Preferred Stack:** Node.js • TypeScript • NestJS • PostgreSQL • Docker • AWS
